...
| Models | Synced from Tony's Google Drive via rclone (conf on volume at `/workspace/rclone/rclone.conf`). NO Hugging Face — Tony has no HF token. Training base model source: TBD |
